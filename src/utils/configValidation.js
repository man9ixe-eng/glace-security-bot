...
function getConfigurationReport() {
  ...
  report.reviewOnCallPanel = makeState([
    ...(!(has('INTERN_REVIEW_PING_ROLE_ID') || has('INTERN_TEAM_REVIEW_PING_ROLE_ID')) ? ['INTERN_REVIEW_PING_ROLE_ID'] : []),
    ...(!(has('MANAGEMENT_REVIEW_PING_ROLE_ID') || has('MANAGER_REVIEW_PING_ROLE_ID')) ? ['MANAGEMENT_REVIEW_PING_ROLE_ID'] : []),
    ...(!(has('SENIOR_MANAGEMENT_REVIEW_PING_ROLE_ID') || has('SENIOR_REVIEW_PING_ROLE_ID')) ? ['SENIOR_MANAGEMENT_REVIEW_PING_ROLE_ID'] : []),
