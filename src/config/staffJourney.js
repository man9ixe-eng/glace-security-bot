...
const ANNOUNCEMENT_CHANNEL_ID = String(
  process.env.STAFF_UPDATES_CHANNEL_ID ||
  process.env.STAFF_POSTS_CHANNEL_ID ||
  process.env.STAFF_JOURNEY_ANNOUNCEMENTS_CHANNEL_ID ||
  '',
).trim();
